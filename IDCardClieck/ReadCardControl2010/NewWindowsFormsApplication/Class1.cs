...
namespace Common
{
    ...
    {
        public static string SaveFilePath = Application.StartupPath;
        /// <summary>
        /// 创建RSA公钥私钥
        /// </summary>
        public static void CreateRSAKey()
        {
            ...
            //设置[公钥私钥]文件路径
            string privateKeyPath = SaveFilePath + "\\PrivateKey.xml";// @"d:\\PrivateKey.xml";
            string publicKeyPath = SaveFilePath + "\\PublicKey.xml"; //@"d:\\PublicKey.xml"
            //创建RSA对象
