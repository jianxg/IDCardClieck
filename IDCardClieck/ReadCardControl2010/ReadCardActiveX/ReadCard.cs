...
//    }
    ...
    public class ReadCardActiveX : UserControl, IObjectSafety, IOCardActiveX
    {        
        ...
        public void ReadCardInfo()
        {
            ...
            {                
                ...
                //int SDTCount = 0;
                //int HIDCount = 0;
                //int iopen = FindAllUSB(ref SDTCount, ref HIDCount);
                //if (iopen != 1)
                //{
                //    SetText("未检测到设备!", lbl_msg);
                //    _runState = "未检测到设备";
                //    return;
                //}
                ...
                //else if (HIDCount > 0)
                //{
                //    for (int nJ = 1; nJ <= HIDCount; nJ++)
                //    {
                //        int ret = SelectUSB(nJ);
                //        if (ret == 1)
                //        {
                //            EdziPortID = nJ;
                //            break;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ReadCardActiveX));
