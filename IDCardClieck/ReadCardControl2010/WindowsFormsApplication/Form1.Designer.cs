...
namespace WindowsFormsApplication
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.newReadCard1 = new GSFramework.ReadCardActiveX();
            ...
            this.newReadCard1.OnDataBind += new GSFramework.ReadCardActiveX.ReadDataHandler(this.newReadCard1_OnDataBand);
            this.newReadCard1.OnStateChanged += new GSFramework.ReadCardActiveX.StateChangeHandler(this.newReadCard1_OnStateChanged);
            // 
            // button2
            // 
        ...
        private ReadCardActiveX newReadCard1;
