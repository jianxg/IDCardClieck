...
namespace IDCardClieck.Common
{
    public class DbHelperSQL
    {
        ...
                /// 该操作将阻止默认值的使用.  
                /// </summary>DbHelperSQLDbHelperSQL  
                /// <param>命令名</param>  
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = DbHelperSQLParameterCache.GetSpParameterSet(connectionString, spName);
                // 给存储过程参数赋值  
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // 从缓存中加载存储过程参数  
                SqlParameter[] commandParameters = DbHelperSQLParameterCache.GetSpParameterSet(connection, spName);
                // 给存储过程分配参数值  
                AssignParameterValues(commandParameters, parameterValues);
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = DbHelperSQLParameterCache.GetSpParameterSet(transaction.Connection, spName);
                // 给存储过程参数赋值  
                AssignParameterValues(commandParameters, parameterValues);
                // 调用重载方法  
        ...
        /// <summary>  
                /// 枚举,标识数据库连接是由DbHelperSQL提供还是由调用者提供  
                /// </summary>  
        private enum SqlConnectionOwnership
        {
            /// <summary>由DbHelperSQL提供连接</summary>  
            Internal,
        ...
                /// </summary>  
                /// <remarks>  
                /// 如果是DbHelperSQL打开连接,当连接关闭DataReader也将关闭.  
        ...
                /// <param>标识数据库连接对象是由调用者提供还是由DbHelperSQL提供</param>  
    ...
    /// <summary>  
        /// DbHelperSQLParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数.  
        /// </summary>  
    public sealed class DbHelperSQLParameterCache
    {
        #region 私有方法,字段,构造函数  
        // 私有构造函数,妨止类被实例化.  
        private DbHelperSQLParameterCache() { }
        // 这个方法要注意  
